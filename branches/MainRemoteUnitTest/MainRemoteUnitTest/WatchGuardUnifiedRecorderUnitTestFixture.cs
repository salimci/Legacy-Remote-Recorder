...
using Natek.Recorders.Remote.Unified.WatchGuardRecorder;
...
namespace Natek.Recorders.Remote.Test
{
    ...
    [TestFixture]
    public class WatchGuardUnifiedRecorderUnitTestFixture
    {
        private static RecorderBase _watchguard;

        /// <summary>
        /// Create a WatchGuardUnifiedRecorder object for testing.
        /// </summary>
        [SetUp]
        public void TestFixtureSetup()
        {
            _watchguard = new WatchGuardUnifiedRecorder();
        }

        /// <summary>
        /// Clear WatchGuardUnifiedRecorder object and set it null for dispose.
        /// </summary>
        [TearDown]
        ...
        public void Convert2Date_IfFieldvaluesIsNull_ReturnStringEmpty()
        {
            ...
            var actual = MethodTestHelper.RunInstanceMethod<WatchGuardUnifiedRecorder, object>("Convert2Date", _watchguard, new[] { rec, field, fieldValues, data });
        ...
        ///		* rec = null 
        ///		* field = null 
        ///		* fieldvalues = 06-21-2013 10:46:52 
        ///		* data = null
        /// 
        /// Expected Output : 
        ...
        public void Convert2Date_IfFieldvaluesNotNull_returnDate()
        {
            ...
            RecWrapper rec = null;
            string field = null;
            string[] fieldValues = { "06-21-2013 10:46:52" };
            object data = null;
            ...
            //Assert
            Assert.AreEqual(actual, "06-21-2013 10:46:52");
        ...
        public int Convert2Date_IfDateFormatIsWrong_ReturnStringEmpty(string fieldvalue)
        {
            ...
            //Act
            // ReSharper disable ExpressionIsAlwaysNull
            var actual =(int) MethodTestHelper.RunInstanceMethod<WatchGuardUnifiedRecorder, object>("Convert2Date", _watchguard, new[] { rec, field, fieldvalues, data });
            // ReSharper restore ExpressionIsAlwaysNull
        ...
        public void OnBeforeProcessRecordInput_IfContextHeaderInfoIsNull_ReturnNextInstruction()
        {
            ...
            // ReSharper disable ExpressionIsAlwaysNull
            var actual = MethodTestHelper.RunInstanceMethod<WatchGuardUnifiedRecorder, NextInstruction>("OnBeforeProcessRecordInput", _watchguard, new object[] { context });
            // ReSharper restore ExpressionIsAlwaysNull
