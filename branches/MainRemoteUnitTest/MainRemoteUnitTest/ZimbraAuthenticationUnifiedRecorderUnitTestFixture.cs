...
using Natek.Recorders.Remote.Unified.ZimbraUnifiedRecorder;
...
namespace Natek.Recorders.Remote.Test
{
    ...
    [TestFixture]
    public class ZimbraAuthenticationUnifiedRecorderUnitTestFixture
    {
        private RecorderBase _zimbra;

        /// <summary>
        /// Create a ZimbraUnifiedRecorder object for testing.
        /// </summary>
        [SetUp]
        ...
        /// <summary>
        /// Clear ZimbraUnifiedRecorder object and set it null for dispose.
        /// </summary>
        [TearDown]
        ...
        public void Convert2Date_IfFieldvaluesIsNull_ReturnStringEmpty()
        {
            ...
            var actual = MethodTestHelper.RunInstanceMethod<ZimbraUnifiedRecorder, object>("Convert2Date", _zimbra, new[] { rec, field, fieldValues, data });
        ...
        public object Convert2Date_IfFieldvaluesNotNull_returnDate(string fieldvalue)
        {
            ...
            // ReSharper disable ExpressionIsAlwaysNull
            var actual = (string)MethodTestHelper.RunInstanceMethod<ZimbraUnifiedRecorder, object>("Convert2Date", _zimbra, new[] { rec, field, fieldValues, data });
            // ReSharper restore ExpressionIsAlwaysNull
        ...
        public int Convert2Date_IfDateFormatIsWrong_ReturnStringEmpty(string fieldvalue)
        {
            ...
            //Act
            // ReSharper disable ExpressionIsAlwaysNull
            var actual = (int)MethodTestHelper.RunInstanceMethod<ZimbraUnifiedRecorder, object>("Convert2Date", _zimbra, new[] { rec, field, fieldvalues, data });
            // ReSharper restore ExpressionIsAlwaysNull
        ...
        public void GetHeaderInfo_IfContextIsNull_ReturnNextInstructionDo()
        {
            ...
            // ReSharper disable ExpressionIsAlwaysNull
            var actual = MethodTestHelper.RunInstanceMethod<ZimbraUnifiedRecorder, NextInstruction>("GetHeaderInfo", _zimbra, new object[] { context, e });
            // ReSharper restore ExpressionIsAlwaysNull
        ...
        public void GetHeaderText_IfContextIsNull_ReturnNull()
        {
            ...
            // ReSharper disable ExpressionIsAlwaysNull
            var actual = MethodTestHelper.RunInstanceMethod<ZimbraUnifiedRecorder, string>("GetHeaderText", _zimbra, new object[] { context });
            // ReSharper restore ExpressionIsAlwaysNull
        ...
        public void OnFieldMatch_IfMatchIsSuccess_ReturnNextInstructionReturn()
        {
            ...
            // ReSharper disable ExpressionIsAlwaysNull
            var actual = MethodTestHelper.RunInstanceMethod<ZimbraUnifiedRecorder, NextInstruction>("OnFieldMatch", _zimbra, new object[] { context, field, match });
            // ReSharper restore ExpressionIsAlwaysNull
