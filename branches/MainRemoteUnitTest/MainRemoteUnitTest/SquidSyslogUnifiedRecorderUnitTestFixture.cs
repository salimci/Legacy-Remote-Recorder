...
using Natek.Recorders.Remote.Unified.SquidSyslogUnifiedRecorder;
...
namespace Natek.Recorders.Remote.Test
{
    ...
    [TestFixture]
    public class SquidSyslogUnifiedRecorderUnitTestFixture
    {
        private static RecorderBase _squidsys;

        /// <summary>
        /// Create a SquidSyslogUnifiedRecorder object for testing.
        /// </summary>
        [SetUp]
        ...
        /// <summary>
        /// Clear SquidSyslogUnifiedRecorder object and set it null for dispose.
        /// </summary>
        [TearDown]
        ...
        public void Convert2Date_IfFieldvaluesIsNull_ReturnStringEmpty()
        {
            ...
            var actual = MethodTestHelper.RunInstanceMethod<SquidSyslogUnifiedRecorder, object>("Convert2Date", _squidsys, new[] { rec, field, fieldValues, data });
        ...
        public void Convert2Date_IfFieldvaluesNotNull_returnDate()
        {
            ...
            RecWrapper rec = null;
            string field = null;
            string[] fieldValues = { "SEP 10 14:33:58" };
            object data = null;
        ...
        public int Convert2Date_IfDateFormatIsWrong_ReturnStringEmpty(string fieldvalue)
        {
            ...
            //Act
            // ReSharper disable ExpressionIsAlwaysNull
            var actual =(int) MethodTestHelper.RunInstanceMethod<SquidSyslogUnifiedRecorder, object>("Convert2Date", _squidsys, new[] { rec, field, fieldvalues, data });
            // ReSharper restore ExpressionIsAlwaysNull
        ...
        ///Method Description : Matching with regex at the moment file line
        ///
        ///Test Scenario : If match is success for mock data
        ///
        ///Known Input :
        ///    * match = at the moment pattern
        ///
        ...
        ///    * NextInstruction.Return should return
        /// </summary>
        [Test(Description = "If OnFieldMatch is success for mock data")]
        ...
        public void OnBeforeProcessRecordInput_IfContextHeaderInfoIsNull_ReturnNextInstruction()
        {
            ...
            // ReSharper disable ExpressionIsAlwaysNull
            var actual = MethodTestHelper.RunInstanceMethod<SquidSyslogUnifiedRecorder, NextInstruction>("OnBeforeProcessRecordInput", _squidsys, new object[] { context });
            // ReSharper restore ExpressionIsAlwaysNull
