...
using Natek.Recorders.Remote.Unified.WampServerUnifiedRecorder;
...
namespace Natek.Recorders.Remote.Test
{
    ...
    [TestFixture]
    public class WampServerUnifiedRecorderUnitTestFixture
    {
        private RecorderBase _wampserver;

        /// <summary>
        /// Create a WampServerUnifiedRecorder object for testing.
        /// </summary>
        [SetUp]
        public void TestFixtureSetup()
        {
            _wampserver = new WampServerUnifiedRecorder();
        }

        /// <summary>
        /// Clear WampServerUnifiedRecorder object and set it null for dispose.
        /// </summary>
        [TearDown]
        ...
        public void Convert2Date_IfFieldvaluesIsNull_ReturnStringEmpty()
        {
            ...
            var actual = MethodTestHelper.RunInstanceMethod<WampServerUnifiedRecorder, object>("Convert2Date", _wampserver, new[] { rec, field, fieldValues, data });
        ...
        public object Convert2Date_IfFieldvaluesNotNull_returnDate(string fieldvalue)
        {
            ...
            // ReSharper disable ExpressionIsAlwaysNull
            var actual = (int)MethodTestHelper.RunInstanceMethod<WampServerUnifiedRecorder, object>("Convert2Date", _wampserver, new[] { rec, field, fieldValues, data });
            // ReSharper restore ExpressionIsAlwaysNull
        ...
        public void GetHeaderInfo_IfContextIsNull_ReturnNextInstructionDo()
        {
            ...
            // ReSharper disable ExpressionIsAlwaysNull
            var actual = MethodTestHelper.RunInstanceMethod<WampServerUnifiedRecorder, NextInstruction>("GetHeaderInfo", _wampserver, new object[] { context, e });
            // ReSharper restore ExpressionIsAlwaysNull
        ...
        public void GetHeaderText_IfContextIsNull_ReturnNull()
        {
            ...
            // ReSharper disable ExpressionIsAlwaysNull
            var actual = MethodTestHelper.RunInstanceMethod<WampServerUnifiedRecorder, string>("GetHeaderText", _wampserver, new object[] { context });
            // ReSharper restore ExpressionIsAlwaysNull
        ...
        public void OnFieldMatch_IfMatchIsSuccess_ReturnNextInstructionReturn()
        {
            ...
            // ReSharper disable ExpressionIsAlwaysNull
            var actual = MethodTestHelper.RunInstanceMethod<WampServerUnifiedRecorder, NextInstruction>("OnFieldMatch", _wampserver, new object[] { context, field, match });
            // ReSharper restore ExpressionIsAlwaysNull
