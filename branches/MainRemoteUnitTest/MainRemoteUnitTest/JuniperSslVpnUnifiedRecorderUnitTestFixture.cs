...
using Natek.Recorders.Remote.Unified.JuniperSslVpnUnifiedRecorder;
...
namespace Natek.Recorders.Remote.Test
{
    ...
    [TestFixture]
    public class JuniperSslVpnUnifiedRecorderUnitTestFixture
    {
        private static RecorderBase _juniperssl;

        /// <summary>
        /// Create a JuniperSslVpnUnifiedRecorder object for testing.
        /// </summary>
        [SetUp]
        public void TestFixtureSetup()
        {
            _juniperssl = new JuniperSslVpnUnifiedRecorder();
        }

        /// <summary>
        /// Clear JuniperSslVpnUnifiedRecorder object and set it null for dispose.
        /// </summary>
        [TearDown]
        ...
        public void Convert2Date_IfFieldvaluesIsNull_ReturnStringEmpty()
        {
            ...
            var actual = MethodTestHelper.RunInstanceMethod<JuniperSslVpnUnifiedRecorder, object>("Convert2Date", _juniperssl, new[] { rec, field, fieldValues, data });
        ...
        public void Convert2Date_IfFieldvaluesNotNull_returnDate()
        {
            ...
            RecWrapper rec = null;
            string field = null;
            string[] fieldValues = { "2014 SEP 10 14:33:58" };
            object data = null;
        ...
        public int Convert2Date_IfDateFormatIsWrong_ReturnStringEmpty(string fieldvalue)
        {
            ...
            //Act
            // ReSharper disable ExpressionIsAlwaysNull
            var actual =(int) MethodTestHelper.RunInstanceMethod<JuniperSslVpnUnifiedRecorder, object>("Convert2Date", _juniperssl, new[] { rec, field, fieldvalues, data });
            // ReSharper restore ExpressionIsAlwaysNull
        ...
        {
            //Arrange
            var context = new SyslogRecorderContext(_juniperssl, ProtocolType.Udp, syslogAddress: "192.168.1.25")
            {
                HeaderInfo = null
            };
            ...
            // ReSharper disable ExpressionIsAlwaysNull
            var actual = MethodTestHelper.RunInstanceMethod<JuniperSslVpnUnifiedRecorder, NextInstruction>("OnBeforeProcessRecordInput", _juniperssl, new object[] { context });
            // ReSharper restore ExpressionIsAlwaysNull
        ...
        public void OnFieldMatch_IfMatchIsNotSuccess_ReturnNextInstructionSkip()
        {
            ...
            // ReSharper disable ExpressionIsAlwaysNull
            var actual = MethodTestHelper.RunInstanceMethod<JuniperSslVpnUnifiedRecorder, NextInstruction>("OnFieldMatch", _juniperssl, new object[] { context, field, match });
            // ReSharper restore ExpressionIsAlwaysNull
