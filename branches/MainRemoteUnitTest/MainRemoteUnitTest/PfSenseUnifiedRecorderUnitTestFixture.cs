...
namespace Natek.Recorders.Remote.Test
{
    ...
    [TestFixture]
    public class PfSenseUnifiedRecorderUnitTestFixture
    {
        private static RecorderBase _pfsense;

        /// <summary>
        /// Create a PfSenseUnifiedRecorder object for testing.
        /// </summary>
        [SetUp]
        public void TestFixtureSetup()
        {
            _pfsense = new PfSenseUnifiedRecorder();
        }

        /// <summary>
        /// Clear PfSenseUnifiedRecorder object and set it null for dispose.
        /// </summary>
        [TearDown]
        ...
        public void Convert2Date_IfFieldvaluesIsNull_ReturnStringEmpty()
        {
            ...
            var actual = MethodTestHelper.RunInstanceMethod<PfSenseUnifiedRecorder, object>("Convert2Date", _pfsense, new[] { rec, field, fieldValues, data });
        ...
        public void Convert2Date_IfFieldvaluesNotNull_returnDate()
        {
            ...
            RecWrapper rec = null;
            string field = null;
            string[] fieldValues = { "02-2014-08 14:33:58" };
            object data = null;
        ...
        public int Convert2Date_IfDateFormatIsWrong_ReturnStringEmpty(string fieldvalue)
        {
            ...
            //Act
            // ReSharper disable ExpressionIsAlwaysNull
            var actual = (int)MethodTestHelper.RunInstanceMethod<PfSenseUnifiedRecorder, object>("Convert2Date", _pfsense, new[] { rec, field, fieldvalues, data });
            // ReSharper restore ExpressionIsAlwaysNull
        ...
        {
            //Arrange
            var context = new SyslogRecorderContext(_pfsense, ProtocolType.Udp, "192.168.1.25")
            {
                HeaderInfo = null
            };
            ...
            // ReSharper disable ExpressionIsAlwaysNull
            var actual = MethodTestHelper.RunInstanceMethod<PfSenseUnifiedRecorder, NextInstruction>("OnBeforeProcessRecordInput", _pfsense, new object[] { context });
            // ReSharper restore ExpressionIsAlwaysNull
        ...
        public void OnFieldMatch_IfMatchIsNotSuccess_ReturnNextInstructionSkip()
        {
            ...
            string field = null;
            var context = new SyslogRecorderContext(_pfsense, ProtocolType.Udp, syslogAddress: "192.168.1.25");

            //Act

            // ReSharper disable ExpressionIsAlwaysNull
            var actual = MethodTestHelper.RunInstanceMethod<PfSenseUnifiedRecorder, NextInstruction>("OnFieldMatch", _pfsense, new object[] { context, field, match });
            // ReSharper restore ExpressionIsAlwaysNull
