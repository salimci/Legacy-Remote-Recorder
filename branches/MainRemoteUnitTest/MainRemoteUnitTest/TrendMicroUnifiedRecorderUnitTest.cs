...
using Natek.Recorders.Remote.Unified.TrendMicroUnifiedRecorder;
using NUnit.Framework;

namespace Natek.Recorders.Remote.Test
{
    [TestFixture]
    public class TrendMicroUnifiedRecorderUnitTest
    {
        private static RecorderBase _trendMicroUnifiedRecorder;
        ...
        {
            _trendMicroUnifiedRecorder = new TrendMicroUnifiedRecorder();
        }
        ...
        {
            _trendMicroUnifiedRecorder.Clear();
            _trendMicroUnifiedRecorder = null;
        }
        ...
        public void Convert2Date_IfDataIsNull_ReturnNullReferenceException()
        {
            ...
            MethodTestHelper.RunInstanceMethod<TrendMicroUnifiedRecorder>("Convert2Date", _trendMicroUnifiedRecorder, new[] { rec, field, values, data });
        ...
        public void Convert2Date_IfDateTimeFormatIsYYYY_MM_dd_Return_YYYY_MM_dd()
        {
            ...
            object data = new TrendMicroUnifiedRecorder();

            //Act

            // ReSharper disable ExpressionIsAlwaysNull
            var actual = MethodTestHelper.RunInstanceMethod<TrendMicroUnifiedRecorder, object>("Convert2Date", _trendMicroUnifiedRecorder, new[] { rec, field, values, data });
            // ReSharper restore ExpressionIsAlwaysNull
        ...
        public void CreateHeaderSeparator_IfRegexIsWrong_Return()
        {
            ...
            //Act
            var actual = MethodTestHelper.RunInstanceMethod<TrendMicroUnifiedRecorder, Regex>("CreateHeaderSeparator", _trendMicroUnifiedRecorder, new object[] { });
        ...
        public void CreateFieldSeparator_IfRegexIsWrong_Return()
        {
            ...
            //Act
            var actual = MethodTestHelper.RunInstanceMethod<TrendMicroUnifiedRecorder, Regex>("CreateFieldSeparator", _trendMicroUnifiedRecorder, new object[] { });
        ...
        public void GetHeaderText_IfContextIsNull_ReturnStringEmpty()
        {
            ...
            // ReSharper disable ExpressionIsAlwaysNull
            var actual = MethodTestHelper.RunInstanceMethod<TrendMicroUnifiedRecorder, string>("GetHeaderText", _trendMicroUnifiedRecorder, new object[] { context });
            // ReSharper restore ExpressionIsAlwaysNull
        ...
        ///
        ///Known Input :
        ///    * context = FileLineRecorderContext(_trendMicroUnifiedRecorder)
        ///Expected Output :
        ///    * string.Empty should return
        /// </summary>
        ...
        public void GetHeaderText_IfContextIsNotNull_ReturnStringEmpty()
        {
            ...
            var context = new FileLineRecorderContext(_trendMicroUnifiedRecorder);
        ...
        ///
        ///Method Description : Create new TrendMicroUnifiedRecorderContext
        ///
        ...
        ///Expected Output :
        ///    * Return TrendMicroUnifiedRecorderContext
        /// </summary>
        [Test(Description = "If context instance is created, return TrendMicroUnifiedRecorderContext")]
        public void CreateContextInstance_InstanceIsCreated_ReturnContext()
        {
            ...
            var actual = MethodTestHelper.RunInstanceMethod<TrendMicroUnifiedRecorder, RecorderContext>("CreateContextInstance", _trendMicroUnifiedRecorder, new object[] { ctxArgs });
        ...
        public void OnArgParsed_IfKeywordIsNotDF_ReturnTrue()
        {
            ...
            // ReSharper disable ExpressionIsAlwaysNull
            var actual = MethodTestHelper.RunInstanceMethod<TrendMicroUnifiedRecorder, bool>("OnArgParsed", _trendMicroUnifiedRecorder, new object[] { keyword, quotedKeyword, value, quotedValue, touchCount, exception });
            // ReSharper restore ExpressionIsAlwaysNull
        ...
        public void InputTextType_IfContextIsNull_NullReferenceException()
        {
            ...
            // ReSharper disable ExpressionIsAlwaysNull
            MethodTestHelper.RunInstanceMethod<TrendMicroUnifiedRecorder, RecordInputType>("InputTextType", _trendMicroUnifiedRecorder, new object[] { context, error });
            // ReSharper restore ExpressionIsAlwaysNull
        ...
        {
            //Arrange
            var context = new FileLineRecorderContext(_trendMicroUnifiedRecorder) { InputRecord = null };
            Exception error = null;

            //Act

            // ReSharper disable ExpressionIsAlwaysNull
            var actual = MethodTestHelper.RunInstanceMethod<TrendMicroUnifiedRecorder, RecordInputType>("InputTextType", _trendMicroUnifiedRecorder, new object[] { context, error });
            // ReSharper restore ExpressionIsAlwaysNull
        ...
        public void OnFieldMatch_IfContextIsNull_ReturnNextInstructionAbort()
        {
            ...
            // ReSharper disable ExpressionIsAlwaysNull
            var actual = MethodTestHelper.RunInstanceMethod<TrendMicroUnifiedRecorder, NextInstruction>("OnFieldMatch", _trendMicroUnifiedRecorder, new object[] { context, source, match });
            // ReSharper restore ExpressionIsAlwaysNull
        ...
        public void OnFieldMatch_IfsourceIsempty_ReturnNextInstructionAbort()
        {
            //Arrange
            Match match = null;
            RecorderContext context = new FileLineRecorderContext(_trendMicroUnifiedRecorder);
            var source = string.Empty;
