...
using Natek.Recorders.Remote.Unified.WatchGuardFirewallUnifiedRecorder;

namespace Natek.Recorders.Remote.Test
{
  
    [TestFixture]
    public class WatchGuardFirewallUnifiedRecorderUnitTestFixture
    {

        private static RecorderBase _watchguardfirewall;

        /// <summary>
        /// Create a WatchGuardFirewallUnifiedRecorder object for testing.
        /// </summary>
        [SetUp]
        public void TestFixtureSetup()
        {
            _watchguardfirewall = new WatchGuardFirewallUnifiedRecorder();
        }

        /// <summary>
        /// Clear WatchGuardFirewallUnifiedRecorder object and set it null for dispose.
        /// </summary>
        [TearDown]
        public void TestFixtureTearDown()
        {
            _watchguardfirewall.Clear();
            _watchguardfirewall = null;
        }
        ...
        public void Convert2Date_IfFieldvaluesIsNull_ReturnStringEmpty()
        {
            ...
            var actual = MethodTestHelper.RunInstanceMethod<WatchGuardFirewallUnifiedRecorder, object>("Convert2Date", _watchguardfirewall, new[] { rec, field, fieldValues, data });
        ...
        public void Convert2Date_IfFieldvaluesNotNull_returnDate()
        {
            ...
            RecWrapper rec = null;
            string field = null;
            string[] fieldValues = { "2014-09-08T14:33:58" };
            object data = null;
        ...
        public int Convert2Date_IfDateFormatIsWrong_ReturnStringEmpty(string fieldvalue)
        {
            ...
            //Act
            // ReSharper disable ExpressionIsAlwaysNull
            var actual =(int) MethodTestHelper.RunInstanceMethod<WatchGuardFirewallUnifiedRecorder, object>("Convert2Date", _watchguardfirewall, new[] { rec, field, fieldvalues, data });
            // ReSharper restore ExpressionIsAlwaysNull
        ...
        {
            //Arrange
            var context = new SyslogRecorderContext(_watchguardfirewall, ProtocolType.Udp, syslogAddress: "192.168.1.25")
            {
                HeaderInfo = null
            };
            ...
            // ReSharper disable ExpressionIsAlwaysNull
            var actual = MethodTestHelper.RunInstanceMethod<WatchGuardFirewallUnifiedRecorder, NextInstruction>("OnBeforeProcessRecordInput", _watchguardfirewall, new object[] { context });
            // ReSharper restore ExpressionIsAlwaysNull
        ...
        public void OnFieldMatch_IfMatchIsNotSuccess_ReturnNextInstructionSkip()
        {
            ...
            // ReSharper disable ExpressionIsAlwaysNull
            var actual = MethodTestHelper.RunInstanceMethod<WatchGuardFirewallUnifiedRecorder, NextInstruction>("OnFieldMatch", _watchguardfirewall, new object[] { context, field, match });
            // ReSharper restore ExpressionIsAlwaysNull
        ...
        public void OnFieldMatch_IfMatchIsNullInput_ReturnNextInstructionSkip()
        {
            ...
            string field = null;
            var context = new SyslogRecorderContext(_watchguardfirewall, ProtocolType.Udp, "192.168.1.25");
