...
using Natek.Recorders.Remote.Unified.Ftp2012UnifiedRecorder;
using NUnit.Framework;

namespace Natek.Recorders.Remote.Test
{
    [TestFixture]
    public class Ftp2012UnifiedRecorderUnitTest
    {
        private static RecorderBase _ftp2012UnifiedRecorder;

        /// <summary>
        /// Create a Ftp2012UnifiedRecorder object for testing.
        /// </summary>
        [SetUp]
        public void TestFixtureSetup()
        {
            _ftp2012UnifiedRecorder = new Ftp2012UnifiedRecorder();
        }

        /// <summary>
        /// Clear Ftp2012UnifiedRecorder object and set it null for dispose
        /// </summary>
        [TearDown]
        public void TestFixtureTearDown()
        {
            _ftp2012UnifiedRecorder.Clear();
            _ftp2012UnifiedRecorder = null;
        }
        ...
        public void Convert2Date_IfDataIsNull_ReturnNullReferenceException()
        {
            ...
            MethodTestHelper.RunInstanceMethod<Ftp2012UnifiedRecorder>("Convert2Date", _ftp2012UnifiedRecorder, new[] { rec, field, values, data });
        ...
        public void Convert2Date_IfDateTimeFormatIsYYYY_MM_dd_Return_YYYY_MM_dd()
        {
            ...
            object data = new Ftp2012UnifiedRecorder();

            //Act

            // ReSharper disable ExpressionIsAlwaysNull
            var actual = MethodTestHelper.RunInstanceMethod<Ftp2012UnifiedRecorder, object>("Convert2Date", _ftp2012UnifiedRecorder, new[] { rec, field, values, data });
            // ReSharper restore ExpressionIsAlwaysNull
        ...
        public void CreateHeaderSeparator_IfRegexIsWrong_Return()
        {
            ...
            //Act
            var actual = MethodTestHelper.RunInstanceMethod<Ftp2012UnifiedRecorder, Regex>("CreateHeaderSeparator", _ftp2012UnifiedRecorder, new object[] { });
        ...
        public void CreateHeaderSeparator_IfRegexIsTrue_ReturnRegex()
        {
            ...
            var expected = new Regex("(?<DATE>[\\w-\\/]*)\\s*(?<TIME>[0-9:]+)\\s*(?<C_IP>[0-9\\.]+)\\s*(?<CS_USERNAME>.[^\\s]+)?\\s*(?<S_IP>[0-9\\.]+)?\\s*(?<S_PORT>[0-9]+)?\\s*(?<CS_METHOD>[\\w]+)\\s*(?<CS_URI_STEM>.[^\\s]+)\\s*(?<SC_STATUS>.[^\\s]+)\\s*(?<SC_WIN32_STATUS>.[^\\s]+)?\\s*(?<SC_SUBSTATUS>.[^\\s]+)?\\s*(?<X_SESSION>.[^\\s]+)?\\s*(?<X_FULLPATH>.[^\\s]+)");
            //Act
        ...
        public void CreateFieldSeparator_IfRegexIsWrong_Return()
        {
            ...
            //Act
            var actual = MethodTestHelper.RunInstanceMethod<Ftp2012UnifiedRecorder, Regex>("CreateFieldSeparator", _ftp2012UnifiedRecorder, new object[] { });
        ...
        public void InputTextType_IfContextIsNull_NullReferenceException()
        {
            ...
            // ReSharper disable ExpressionIsAlwaysNull
            MethodTestHelper.RunInstanceMethod<Ftp2012UnifiedRecorder, RecordInputType>("InputTextType", _ftp2012UnifiedRecorder, new object[] { context, error });
            // ReSharper restore ExpressionIsAlwaysNull
        ...
        {
            //Arrange
            var context = new FileLineRecorderContext(_ftp2012UnifiedRecorder) { InputRecord = null };
            Exception error = null;

            //Act

            // ReSharper disable ExpressionIsAlwaysNull
            var actual = MethodTestHelper.RunInstanceMethod<Ftp2012UnifiedRecorder, RecordInputType>("InputTextType", _ftp2012UnifiedRecorder, new object[] { context, error });
            // ReSharper restore ExpressionIsAlwaysNull
        ...
        public void GetHeaderText_IfContextIsNull_ReturnStringEmpty()
        {
            ...
            // ReSharper disable ExpressionIsAlwaysNull
            var actual = MethodTestHelper.RunInstanceMethod<Ftp2012UnifiedRecorder, string>("GetHeaderText", _ftp2012UnifiedRecorder, new object[] { context });
            // ReSharper restore ExpressionIsAlwaysNull
        ...
        {
            //Arrange
            var context = new SyslogRecorderContext(_ftp2012UnifiedRecorder, ProtocolType.Udp, syslogAddress: "192.168.1.25")
            {
                HeaderInfo = null
            };
        ...
        public void OnFieldMatch_IfMatchIsNotSuccess_ReturnNextInstructionSkip()
        {
            ...
            // ReSharper disable ExpressionIsAlwaysNull
            var actual = MethodTestHelper.RunInstanceMethod<Ftp2012UnifiedRecorder, NextInstruction>("OnFieldMatch", _ftp2012UnifiedRecorder, new object[] { context, field, match });
            // ReSharper restore ExpressionIsAlwaysNull
        ...
        public void OnFieldMatch_IfContextIsNotIncludeSourceHeaderInfo_ReturnNullReferenceException()
        {
            ...
            // ReSharper disable ExpressionIsAlwaysNull
            MethodTestHelper.RunInstanceMethod<Ftp2012UnifiedRecorder, NextInstruction>("OnFieldMatch", _ftp2012UnifiedRecorder, new object[] { context, field, match });
            // ReSharper restore ExpressionIsAlwaysNull
