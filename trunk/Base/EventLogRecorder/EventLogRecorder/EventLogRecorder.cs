...
namespace Parser
{
    public partial class EventLogRecorder : AppParser
    {
        ...
        public Rec setRecParse(Rec r, string sMessage)
        {
            ...
            Log.Log(LogType.FILE, LogLevel.INFORM, "Message:" + sMessage);
            ...
            for (int i = 0; i < DescArr.Length; i++)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        Log.Log(LogType.FILE, LogLevel.INFORM, "DescArr[" + i + "]:" + DescArr[i]);
                        Log.Log(LogType.FILE, LogLevel.INFORM, "lineArr.Length:" + lineArr.Length.ToString());
            ...
            if (rec.Description.Length > 900)
            {
                ...
                Log.Log(LogType.FILE, LogLevel.INFORM, "Description text splitted to CustomStr10");
