...
namespace Parser
{
    ...
    public class DhcpReserveRecorder : Parser//recorderName***
    {
        ...
        public DhcpReserveRecorder()//recorderName
            : base()
        {
            LogName = "DhcpReserveRecorder";//recorderName***
        ...
        public DhcpReserveRecorder(String fileName)//recorderName***
            : base(fileName)
        {
