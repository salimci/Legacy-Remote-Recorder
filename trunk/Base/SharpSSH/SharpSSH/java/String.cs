...
namespace SharpSSH.SharpSsh.java
{
	...
	public class String
	{
		...
		public static SharpSSH.SharpSsh.java.String operator+(SharpSSH.SharpSsh.java.String s1, SharpSSH.SharpSsh.java.String s2)
		{
			return new SharpSSH.SharpSsh.java.String(s1.ToString()+s2.ToString());
		}
