...
namespace Parser
{
  public class IIS8V_1_0_0Recorder : Parser
  {
        ...
        public IIS8V_1_0_0Recorder()
            : base()
        {
            LogName = "IIS8V_1_0_0Recorder";
        }
        ...
        public IIS8V_1_0_0Recorder(String fileName)
            : base(fileName)
        {
        } // IIS8V_1_0_0Recorder
        ...
        public override bool ParseSpecific(String line, bool dontSend)
        {
            ...
            if (!dontSend)
            {
                ...
                try
                {
                    ...
                    Log.Log(LogType.FILE, LogLevel.DEBUG, "arr[dateIndex] arr[dictHash[time]]: " + arr[dateIndex] + " " + arr[dictHash["time"]]);

                    Log.Log(LogType.FILE, LogLevel.DEBUG, "Splitting 2.6");
                    try
                    {
                      r.SourceName = Environment.MachineName; //arr[dictHash["s-sitename"]];
                    }
                    catch (Exception e)
                    {
                      Log.Log(LogType.FILE, LogLevel.ERROR, "1" + e.Message);
                    }
