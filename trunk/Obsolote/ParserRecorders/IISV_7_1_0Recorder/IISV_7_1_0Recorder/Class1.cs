...
namespace Parser
{
    public class IISV_7_1_0Recorder : Parser
    {
        ...
        public IISV_7_1_0Recorder()
            : base()
        {
            LogName = "IISV_7_1_0Recorder";
        }
        ...
        public IISV_7_1_0Recorder(String fileName)
            : base(fileName)
        {
        } // IISRecorder
            ...
            String CustomVar1, Int32 CustomVar2, String virtualhost, String dal, Int32 Zone)
        {
            ...
            , dal, Zone);
            if (CustomVar1.Contains(","))
            {
                iisType = Before(CustomVar1, ",");
            }
            else
            {
                iisType = CustomVar1;
        ...
        protected override void ParseFileNameLocal()
        {
            ...
            if (lastFile != null && lastFile != "" && lastFile != " ")
            {
                if (File.Exists(lastFile) == true)
                {
                    ...
                    {
                        fileIsFinished = true;
                        Log.Log(LogType.FILE, LogLevel.INFORM, "Last File .zip ile bittiginden değiştirilecektir");
                    }
                ...
                {
                    Log.Log(LogType.FILE, LogLevel.INFORM, "Dosya Silinmiş Bulunamadı. Sıradaki Dosya Set Edilecek!!  Silinen Dosya : " + lastFile);
                ...
                try
                {
                    if (lastFile != "" && lastFile != null)
                    {
                        ...
                        if (fileNameType == oldFileNameType)
                        {
                            ...
                            Log.Log(LogType.FILE, LogLevel.INFORM, "Old File Name is: " + FileName.ToString());
                            Log.Log(LogType.FILE, LogLevel.INFORM, "tempCustomVar1: " + tempCustomVar1);
                            Log.Log(LogType.FILE, LogLevel.INFORM, "tempCustomVar1 - after  : " + After(tempCustomVar1, ","));
                            Log.Log(LogType.FILE, LogLevel.INFORM, "iistempCustomVar1Type - before : " + Before(tempCustomVar1, ","));//
                        }
                        else
                        {
