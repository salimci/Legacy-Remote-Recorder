...
{
    public class TrendMicroUrlUnifiedRecorder : FileLineRecorder
    {
        ...
        {
            return new TrendMicroUrlUnifiedRecorderContext(this);
        }
        ...
        {
            var ctxFile = context as TrendMicroUrlUnifiedRecorderContext;
