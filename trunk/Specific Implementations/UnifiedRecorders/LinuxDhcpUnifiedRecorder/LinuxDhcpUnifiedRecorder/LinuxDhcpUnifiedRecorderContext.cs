...
{
    class LinuxDhcpUnifiedRecorderContext : LinuxTerminalRecorderContext
    {
        public LinuxDhcpUnifiedRecorderContext()
            : this(null)
        {
        }

        public LinuxDhcpUnifiedRecorderContext(RecorderBase recorder)
            : base(recorder)
        {
        }
