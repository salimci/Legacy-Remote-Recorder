 ...
 */
namespace Natek.Recorders.Remote.Unified.ApacheFileAccessUnifiedRecorder
{
    public class ApacheFileAccessUnifiedRecorder:FileLineRecorder
    {
        ...
        {
            DateTime dt;
            var recorder = data as ApacheFileAccessUnifiedRecorder;
