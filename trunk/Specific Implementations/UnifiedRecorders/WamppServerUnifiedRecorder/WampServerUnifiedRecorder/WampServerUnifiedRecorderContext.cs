...
{
    class WampServerUnifiedRecorderContext : LinuxTerminalRecorderContext
    {

        public WampServerUnifiedRecorderContext()
            : this(null)
        {
        }

        public WampServerUnifiedRecorderContext(RecorderBase recorder)
            : base(recorder)
        {
        }
