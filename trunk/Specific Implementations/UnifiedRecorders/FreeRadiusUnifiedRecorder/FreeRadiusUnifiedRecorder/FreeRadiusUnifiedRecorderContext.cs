...
{
    class FreeRadiusUnifiedRecorderContext : LinuxTerminalRecorderContext
    {

        public FreeRadiusUnifiedRecorderContext()
            : this(null)
        {
        }

        public FreeRadiusUnifiedRecorderContext(RecorderBase recorder)
            : base(recorder)
        {
        }
