...
{
    class MysqlUnifiedRecorderContext : LinuxTerminalRecorderContext
    {
         public MysqlUnifiedRecorderContext()
            : this(null)
        {
        }

         public MysqlUnifiedRecorderContext(RecorderBase recorder)
            : base(recorder)
        {
        }
