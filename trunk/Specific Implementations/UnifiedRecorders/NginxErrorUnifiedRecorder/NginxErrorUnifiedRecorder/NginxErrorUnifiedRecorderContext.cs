...
{
    class NginxErrorUnifiedRecorderContext : LinuxTerminalRecorderContext
    {

        public NginxErrorUnifiedRecorderContext()
            : this(null)
        {
        }

        public NginxErrorUnifiedRecorderContext(RecorderBase recorder)
            : base(recorder)
        {
        }
