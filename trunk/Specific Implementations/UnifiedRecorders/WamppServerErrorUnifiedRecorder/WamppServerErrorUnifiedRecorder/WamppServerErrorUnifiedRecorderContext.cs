...
{
    class WamppServerErrorUnifiedRecorderContext : LinuxTerminalRecorderContext
    {
        public WamppServerErrorUnifiedRecorderContext(RecorderBase recorder): base(recorder)
        {
        }
