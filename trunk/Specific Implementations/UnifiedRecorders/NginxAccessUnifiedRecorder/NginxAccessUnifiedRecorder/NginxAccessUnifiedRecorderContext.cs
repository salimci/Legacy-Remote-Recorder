...
{
    class NginxAccessUnifiedRecorderContext : LinuxTerminalRecorderContext
    {

        public NginxAccessUnifiedRecorderContext()
            : this(null)
        {
        }

        public NginxAccessUnifiedRecorderContext(RecorderBase recorder)
            : base(recorder)
        {
        }
