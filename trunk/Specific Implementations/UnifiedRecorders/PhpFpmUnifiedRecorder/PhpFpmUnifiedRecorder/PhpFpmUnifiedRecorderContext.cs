...
{
    class PhpFpmUnifiedRecorderContext : LinuxTerminalRecorderContext
{
        public PhpFpmUnifiedRecorderContext()
            : this(null)
        {
        }

        public PhpFpmUnifiedRecorderContext(RecorderBase recorder)
            : base(recorder)
        {
        }
