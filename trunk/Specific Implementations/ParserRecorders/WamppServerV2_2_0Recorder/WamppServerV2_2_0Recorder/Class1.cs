...
namespace Parser
{
    ...
    public class WamppServerV2_2_0Recorder : Parser
    {
        ...
        public WamppServerV2_2_0Recorder()
            : base()
        {
            LogName = "WamppServerV2_2_0Recorder";
        ...
        public WamppServerV2_2_0Recorder(String fileName)//recorderName***
            : base(fileName)
        {
