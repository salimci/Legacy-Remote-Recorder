...
namespace Parser
{
    public class LabrisMessageRecorder : Parser
    {
        public LabrisMessageRecorder() : base()
        {
            LogName = "LabrisMessageRecorder";
            usingKeywords = false;
        }
        ...
        public LabrisMessageRecorder(String fileName) : base(fileName)
        {
        }
