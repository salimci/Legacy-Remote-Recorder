...
namespace Parser
{
    public class PaloAltoUrlRecorder : Parser
    {
        public PaloAltoUrlRecorder()
            : base()
        {
            LogName = "PaloAltoUrlRecorder";
            usingKeywords = false;
            lineLimit = 50;
        }
        ...
        public PaloAltoUrlRecorder(String fileName)
            : base(fileName)
        {
        }
        ...
        public override bool ParseSpecific(String line, bool dontSend)
        {
            ...
            if (!dontSend)
            {
                ...
                //  url     Domain*,Receive Time*,Serial #*,Type*,Threat/Content Type*,Config Version*,Generate Time*,Source address*,Destination address*,NAT Source IP*,NAT Destination IP*,Rule*,Source User*,Destination User*,Application*,Virtual System*,Source Zone*,Destination Zone*,Inbound Interface*,Outbound Interface*,Log Action*,Time Logged*,Session ID*,Repeat Count*,Source Port*,Destination Port*,NAT Source Port*,NAT Destination Port*,Flags*,IP Protocol*,Action,URL,  Threat/Content Name,Category,      Severity,Direction
        ...
        protected override void ParseFileNameLocal()
        {
            ...
            try
            {
                if (Dir.EndsWith("/") || Dir.EndsWith("\\"))
                {
                    ...
                    //PA-2020_url_2011_01_26_last_calendar_day.csv
                    foreach (String file in Directory.GetFiles(Dir))
                    {
                        string sFile = Path.GetFileName(file).ToString();
                        if (sFile.Contains("url") == true)
