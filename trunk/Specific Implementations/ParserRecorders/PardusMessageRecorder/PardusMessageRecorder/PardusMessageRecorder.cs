...
namespace Parser
{
    public class PardusMessageRecorder : Parser
    {
        public PardusMessageRecorder()
            : base()
        {
            LogName = "PardusMessageRecorder";
            usingKeywords = false;
        }
        ...
        public PardusMessageRecorder(String fileName)
            : base(fileName)
        {
        }
