//ATOOracleAuditV_1_0_0Recorder

//Name: ATOOracleAuditV_1_0_0Recorder 
...
namespace ATOOracleAuditV_1_0_0Recorder
{
    ...
    public class ATOOracleAuditV_1_0_0Recorder : CustomBase
    {
        ...
        public ATOOracleAuditV_1_0_0Recorder()
        {
            InitializeComponent();
        ...
        public override void Init()
        {
                ...
                if (usingRegistry)
                {
                    if (!reg_flag)
                    {
                        if (!Read_Registry())
                        {
                            ...
                            {
                                L.Log(LogType.FILE, LogLevel.ERROR, "Error on Intialize Logger on ATOOracleAuditV_1_0_0Recorder functions may not be running");
                                return;
                            }
                        reg_flag = true;
                ...
                else
                {
                    if (!reg_flag)
                    {
                        if (!Get_logDir())
                        {
                            ...
                            if (!Initialize_Logger())
                            {
                                L.Log(LogType.FILE, LogLevel.ERROR, "Error on Intialize Logger on ATOOracleAuditV_1_0_0Recorder Recorder  functions may not be running");
                                return;
                            }
                        L.Log(LogType.FILE, LogLevel.INFORM, "Start creating ATOOracleAuditV_1_0_0Recorder DAL");
            ...
            {
                EventLog.WriteEntry("Security Manager ATOOracleAuditV_1_0_0Recorder Recorder Init", er.ToString(), EventLogEntryType.Error);
                L.Log(LogType.FILE, LogLevel.ERROR, "Security Manager ATOOracleAuditV_1_0_0Recorder Recorder Init. " + er.Message);
            }
        }
        ...
        public bool Get_logDir()
        {
            ...
            try
            {
                ...
                err_log = rk.OpenSubKey("Remote Recorder").GetValue("Home Directory").ToString() + @"log\ATOOracleAuditV_1_0_0Recorder" + Id + ".log";
                rk.Close();
                return true;
            }
            catch (Exception er)
            {
                EventLog.WriteEntry("Security Manager ATOOracleAuditV_1_0_0Recorder  Read Registry", er.ToString(), EventLogEntryType.Error);
                L.Log(LogType.FILE, LogLevel.ERROR, "Security Manager ATOOracleAuditV_1_0_0Recorder Read Registry Error. " + er.Message);
                return false;
            }
            finally
            {
        ...
        public bool Read_Registry()
        {
            ...
            {
                rk = Registry.LocalMachine.OpenSubKey("SOFTWARE").OpenSubKey("Natek").OpenSubKey("Security Manager");
                log_size = Convert.ToUInt32(rk.OpenSubKey("Recorder").OpenSubKey("ATOOracleAuditV_1_0_0Recorder").GetValue("Log Size"));
                logging_interval = Convert.ToUInt32(rk.OpenSubKey("Recorder").OpenSubKey("ATOOracleAuditV_1_0_0Recorder").GetValue("Logging Interval"));
                trc_level = Convert.ToInt32(rk.OpenSubKey("Recorder").OpenSubKey("ATOOracleAuditV_1_0_0Recorder").GetValue("Trace Level"));
                err_log = rk.OpenSubKey("Agent").GetValue("Home Directory").ToString() + @"log\ATOOracleAuditV_1_0_0Recorder.log";
                db_name = rk.OpenSubKey("Recorder").OpenSubKey("ATOOracleAuditV_1_0_0Recorder").GetValue("DBName").ToString();
                this.timer1.Interval = Convert.ToInt32(rk.OpenSubKey("Recorder").OpenSubKey("ATOOracleAuditV_1_0_0Recorder").GetValue("Interval"));
                wsdb_name = rk.OpenSubKey("Recorder").OpenSubKey("ATOOracleAuditV_1_0_0Recorder").GetValue("WSDBName").ToString();
                max_record_send = Convert.ToInt32(rk.OpenSubKey("Recorder").OpenSubKey("ATOOracleAuditV_1_0_0Recorder").GetValue("MaxRecordSend"));
                last_recordnum = Convert.ToInt64(rk.OpenSubKey("Recorder").OpenSubKey("ATOOracleAuditV_1_0_0Recorder").GetValue("LastRecordNum"));
        ...
        private void timer1_Tick(object sender, System.Timers.ElapsedEventArgs e)
        {
            ...
            try
            {
                ...
                while (readReader.Read())
                {
                    ...
                    try//
                    {
                        rec.EventType = Convert_To_String(readReader["MODULE"]);
        ...
        //    try
        //    {
        //        string path = @"E:\KGSTest\KGSTest.txt";
        ...
        //        //LogFileSizeControl(path);
        //    }
        //    catch (Exception ex)
        //    {
        //        L.Log(LogType.FILE, LogLevel.ERROR, " //WriteMessage() -->> An error occurred :" + ex.ToString());
        //    }
        //} // //WriteMessage
        ...
        public bool Set_Registry(long status)
        {
            ...
            try
            {
                rk = Registry.LocalMachine.CreateSubKey("SOFTWARE").CreateSubKey("Natek").CreateSubKey("Security Manager").CreateSubKey("Recorder").CreateSubKey("ATOOracleAuditV_1_0_0Recorder");
