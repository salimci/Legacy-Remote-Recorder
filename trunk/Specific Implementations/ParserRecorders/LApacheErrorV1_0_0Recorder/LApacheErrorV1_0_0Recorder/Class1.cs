...
namespace Parser
{
    public class LApacheErrorV1_0_0Recorder : Parser {
        private int port = 22;
        public LApacheErrorV1_0_0Recorder()
            : base()
        {
            LogName = "LApacheErrorV1_0_0Recorder";
            usingKeywords = false;
            lineLimit = 50;
        }

        public LApacheErrorV1_0_0Recorder(String fileName)
            : base(fileName)
        {
            ...
            try
            {
                ...
                if (Dir.EndsWith("/") || Dir.EndsWith("\\"))
                {
                    ...
                    while ((line = sr.ReadLine()) != null)
                    {
                        ...
                        if (arr[arr.Length - 1].StartsWith("error"))//Name changed
                        {
