...
namespace CiscoArpV_1_0_0Recorder
{
    public class Class1
    {
    }
...
namespace CiscoArpV_1_0_0Recorder
{
    public class CiscoArpV_1_0_0Recorder : CustomBase
    {
        ...
        public CiscoArpV_1_0_0Recorder()
        {
            InitializeComponent();
        }
        ...
        public override void Init()
        {
                ...
                if (usingRegistry)
                {
                    if (!reg_flag)
                    {
                        if (!Read_Registry())
                        {
                            ...
                            {
                                L.Log(LogType.FILE, LogLevel.ERROR, "Error on Intialize Logger on CiscoArpV_1_0_0Recorder functions may not be running");
                                return;
                            }
                        reg_flag = true;
                    }
            ...
            {
                EventLog.WriteEntry("Security Manager CiscoArpV_1_0_0Recorder Init", er.ToString(), EventLogEntryType.Error);
            }
        ...
        public bool Get_logDir()
        {
            ...
            try
            {
                ...
                err_log = rk.OpenSubKey("Remote Recorder").GetValue("Home Directory").ToString() + @"log\CiscoArpV_1_0_0Recorder" + ID + ".log";
                rk.Close();
                return true;
            }
            catch (Exception er)
            {
                EventLog.WriteEntry("Security Manager CiscoArpV_1_0_0Recorder Read Registry", er.ToString(), EventLogEntryType.Error);
                return false;
            }
            finally
            {
        ...
        private void timer1_Tick(object sender, System.Timers.ElapsedEventArgs e)
        {
            ...
            try
            {
                ...
                rec.LogName = "CiscoArpV_1_0_0Recorder";
