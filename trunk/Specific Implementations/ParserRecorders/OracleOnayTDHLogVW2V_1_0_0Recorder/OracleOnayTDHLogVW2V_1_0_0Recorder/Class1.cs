//Name: OracleOnayTDHLogVW2 Recorder
...
namespace OracleOnayTDHLogVW2V_1_0_0Recorder
{
    public class OracleOnayTDHLogVW2V_1_0_0Recorder : CustomBase
    {
        ...
        public OracleOnayTDHLogVW2V_1_0_0Recorder()
        {
            InitializeComponent();
        ...
        public override void Init()
        {
            ...
            try
            {
                ...
                else
                {
                    if (!reg_flag)
                    {
                        ...
                        L.Log(LogType.FILE, LogLevel.INFORM, "Start creating OracleOnayTDHLogVW2 DAL");
            ...
            {
                EventLog.WriteEntry("Security Manager OracleOnayTDHLogVW2 Recorder Init", er.ToString(), EventLogEntryType.Error);
                L.Log(LogType.FILE, LogLevel.ERROR, "Security Manager OracleOnayTDHLogVW2 Recorder Init. " + er.Message);
            }
        }
        ...
        public bool Get_logDir()
        {
            ...
            try
            {
                ...
                err_log = rk.OpenSubKey("Remote Recorder").GetValue("Home Directory").ToString() + @"log\OracleOnayTDHLogVW2V_1_0_0Recorder" + Id + ".log";
                rk.Close();
                return true;
            }
            catch (Exception er)
            {
                EventLog.WriteEntry("Security Manager OracleOnayTDHLogVW2 Recorder Read Registry", er.ToString(), EventLogEntryType.Error);
                L.Log(LogType.FILE, LogLevel.ERROR, "Security Manager OracleOnayTDHLogVW2 Recorder Read Registry Error. " + er.Message);
                return false;
            }
            finally
            {
        ...
        public bool Read_Registry()
        {
            ...
            {
                rk = Registry.LocalMachine.OpenSubKey("SOFTWARE").OpenSubKey("Natek").OpenSubKey("Security Manager");
                log_size = Convert.ToUInt32(rk.OpenSubKey("Recorder").OpenSubKey("OracleOnayTDHLogVW2").GetValue("Log Size"));
                logging_interval = Convert.ToUInt32(rk.OpenSubKey("Recorder").OpenSubKey("OracleOnayTDHLogVW2").GetValue("Logging Interval"));
                trc_level = Convert.ToInt32(rk.OpenSubKey("Recorder").OpenSubKey("OracleOnayTDHLogVW2").GetValue("Trace Level"));
                err_log = rk.OpenSubKey("Agent").GetValue("Home Directory").ToString() + @"log\OracleOnayTDHLogVW2.log";
                db_name = rk.OpenSubKey("Recorder").OpenSubKey("OracleOnayTDHLogVW2").GetValue("DBName").ToString();
                this.timer1.Interval = Convert.ToInt32(rk.OpenSubKey("Recorder").OpenSubKey("OracleOnayTDHLogVW2").GetValue("Interval"));
                wsdb_name = rk.OpenSubKey("Recorder").OpenSubKey("OracleOnayTDHLogVW2").GetValue("WSDBName").ToString();
                max_record_send = Convert.ToInt32(rk.OpenSubKey("Recorder").OpenSubKey("OracleOnayTDHLogVW2").GetValue("MaxRecordSend"));
                last_recordnum = Convert.ToInt64(rk.OpenSubKey("Recorder").OpenSubKey("OracleOnayTDHLogVW2").GetValue("LastRecordNum"));
        ...
        public bool Set_Registry(long status)
        {
            ...
            try
            {
                rk = Registry.LocalMachine.CreateSubKey("SOFTWARE").CreateSubKey("Natek").CreateSubKey("Security Manager").CreateSubKey("Recorder").CreateSubKey("OracleOnayTDHLogVW2");
