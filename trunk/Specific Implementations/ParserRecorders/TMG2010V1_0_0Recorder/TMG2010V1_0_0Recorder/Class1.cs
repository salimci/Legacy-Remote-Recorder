...
namespace Parser
{
    ...
    public class TMG2010V1_0_0Recorder : Parser//recorderName***
    {
        ...
        public TMG2010V1_0_0Recorder()
            : base()
        {
            LogName = "TMG2010V1_0_0Recorder";
        ...
        public TMG2010V1_0_0Recorder(String fileName)//recorderName***
            : base(fileName)
        {
