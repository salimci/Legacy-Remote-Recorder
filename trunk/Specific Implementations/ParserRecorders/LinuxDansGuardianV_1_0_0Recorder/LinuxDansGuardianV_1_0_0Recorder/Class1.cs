...
namespace Parser
{
    ...
    public class LinuxDansGuardianV_1_0_0Recorder : Parser
    {
        private string dateFormat = "yyyy/MM/dd HH:mm:ss";
        private Fields RecordFields;

        public LinuxDansGuardianV_1_0_0Recorder()
            : base()
        {
            LogName = "LinuxDansGuardianV_1_0_0Recorder";
            RecordFields = new Fields();
            usingKeywords = false;
            lineLimit = 50;
        }

        public LinuxDansGuardianV_1_0_0Recorder(String fileName)
            : base(fileName)
        {
        ...
        public void WriteMessage(string message)
        {
            try
            {
                string path = @"D:\GuardianTest\GuardianTestFile.txt";
            ...
            {
                Log.Log(LogType.FILE, LogLevel.ERROR, " WriteMessage() -->> An error occurred :" + ex.ToString());
            }
        } // WriteMessage
