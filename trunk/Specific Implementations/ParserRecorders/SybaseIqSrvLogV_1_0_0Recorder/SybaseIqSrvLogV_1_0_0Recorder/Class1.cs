...
//    public class SybaseIqSrvLogV_1_0_0Recorder : Parser
//    {
//        private Fields RecordFields;
//        private string dateFormat = "yyyy-MM-dd HH:mm:ss";

//        public SybaseIqSrvLogV_1_0_0Recorder()
//            : base()
//        {
//            LogName = "SybaseIqSrvLogV_1_0_0Recorder";
...
//        public SybaseIqSrvLogV_1_0_0Recorder(String fileName)
//            : base(fileName)
//        {
//        }
...
//                        if (extensionArr[extensionArr.Length - 1] == "srvlog")
//                        {
...
namespace SybaseIqSrvLogV_1_0_0Recorder
{
    public class SybaseIqSrvLogV_1_0_0Recorder : CustomBase
    {
        ...
        public override void Init()
        {
            try
            {
                    ...
                    if (!reg_flag)
                    {
                        ...
                        else if (!Initialize_Logger())
                        {
                            L.Log(LogType.FILE, LogLevel.ERROR,
                                  "Error on Intialize Logger on SybaseIqSrvLogV_1_0_0Recorder functions may not be running");
                            return;
                        }
                        reg_flag = true;
                    }
                ...
                else
                {
                    if (!reg_flag)
                    {
                        ...
                        {
                            L.Log(LogType.FILE, LogLevel.ERROR,
                                  "Error on Intialize Logger on SybaseIqSrvLogV_1_0_0Recorder Recorder  functions may not be running");
                            return;
                        }
                        L.Log(LogType.FILE, LogLevel.INFORM, "Start creating SybaseIqSrvLogV_1_0_0Recorder DAL");
                        reg_flag = true;
                    }
                }
            }
            ...
            {
                EventLog.WriteEntry("Security Manager SybaseIqSrvLogV_1_0_0Recorder Recorder Init",
                                    exception.ToString(), EventLogEntryType.Error);
            }
            L.Log(LogType.FILE, LogLevel.DEBUG, "  SybaseIqSrvLogV_1_0_0Recorder Init Method end.");
        }
        ...
        public bool Get_logDir()
        {
            ...
            try
            {
                ...
                err_log = rk.OpenSubKey("Remote Recorder").GetValue("Home Directory").ToString() +
                          @"log\SybaseIqSrvLogV_1_0_0Recorder" + Id + ".log";
                rk.Close();
                return true;
            }
            catch (Exception er)
            {
                EventLog.WriteEntry("Security Manager SybaseIqSrvLogV_1_0_0Recorder  Read Registry", er.ToString(),
                                    EventLogEntryType.Error);
                L.Log(LogType.FILE, LogLevel.ERROR,
                      "Security Manager SybaseIqSrvLogV_1_0_0Recorder Read Registry Error. " + er.Message);
                return false;
            }
            finally
            {
        ...
        public bool Read_Registry()
        {
            ...
            try
            {
                ...
                log_size =
                    Convert.ToUInt32(
                        rk.OpenSubKey("Recorder").OpenSubKey("SybaseIqSrvLogV_1_0_0Recorder").GetValue("Log Size"));
                logging_interval =
                    Convert.ToUInt32(
                        rk.OpenSubKey("Recorder").OpenSubKey("SybaseIqSrvLogV_1_0_0Recorder").GetValue(
                            "Logging Interval"));
                trc_level =
                    Convert.ToInt32(
                        rk.OpenSubKey("Recorder").OpenSubKey("SybaseIqSrvLogV_1_0_0Recorder").GetValue("Trace Level"));
                err_log = rk.OpenSubKey("Agent").GetValue("Home Directory").ToString() +
                          @"log\SybaseIqSrvLogV_1_0_0Recorder.log";
                this.timer1.Interval =
                    Convert.ToInt32(
                        rk.OpenSubKey("Recorder").OpenSubKey("SybaseIqSrvLogV_1_0_0Recorder").GetValue("Interval"));
                max_record_send =
                    Convert.ToInt32(
                        rk.OpenSubKey("Recorder").OpenSubKey("SybaseIqSrvLogV_1_0_0Recorder").GetValue(
                            "MaxRecordSend"));
            ...
            try
            {
                ...
                try
                {
                    ...
                    L.Log(LogType.FILE, LogLevel.INFORM,
                          " SybaseIqSrvLogV_1_0_0Recorder In CoderParse() -->> Record sending." + "Id: " + Id +
                    ...
                    L.Log(LogType.FILE, LogLevel.INFORM, " SybaseIqSrvLogV_1_0_0Recorder In CoderParse() -->> Record sended.");
                }
                catch (Exception exception)
                {
                    L.Log(LogType.FILE, LogLevel.ERROR, " SybaseIqSrvLogV_1_0_0Recorder In CoderParse() -->> Record sending Error." + exception.Message);
                }
        ...
        public void CoderParse(String line, long lineCount, string lastFile)
        {
            ...
            {
                Rec r = new Rec();
                r.LogName = "SybaseIqSrvLogV_1_0_0Recorder";
                ...
                if (line.StartsWith("E."))
                {
                    ...
                    r.CustomStr9 = lastFile;
                    CustomServiceBase customServiceBase = base.GetInstanceService("Security Manager Remote Recorder");
                    try
                    {
                        L.Log(LogType.FILE, LogLevel.DEBUG, " SybaseIqSrvLogV_1_0_0Recorder In CoderParse() -->> RemoteRecorder table updating.");
                        customServiceBase.SetData(Dal, virtualhost, r);
                        L.Log(LogType.FILE, LogLevel.DEBUG, " SybaseIqSrvLogV_1_0_0Recorder In CoderParse() -->> RemoteRecorder table updated.");
                    }
                    catch (Exception exception)
                    {
                        L.Log(LogType.FILE, LogLevel.ERROR, " SybaseIqSrvLogV_1_0_0Recorder In CoderParse() -->> RemoteRecorder table update Error." + exception.Message);
                    }
                    last_recordnum = lineCount;
                    LastRecordDate = r.Datetime;
                    try
                    {
                        L.Log(LogType.FILE, LogLevel.INFORM," SybaseIqSrvLogV_1_0_0Recorder In CoderParse() -->> Record sending." + last_recordnum);
        ...
        private bool Is_File_Finished(string file)
        {
            L.Log(LogType.FILE, LogLevel.DEBUG, " SybaseIqSrvLogV_1_0_0Recorder In Is_File_Finished() Started.");
        ...
        private string[] SortFiles(ArrayList arrFileNames)
        {
            ...
            try
            {
                ...
                {
                    string[] parts = arrFileNames[i].ToString().Split(new char[] { '.', '_' }, StringSplitOptions.RemoveEmptyEntries);
                    if (parts.Length == 3 && parts[parts.Length - 1] == "srvlog")
                    {
