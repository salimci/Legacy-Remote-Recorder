...
namespace IISFTPV_1_0_0Recorder
{
    public class Class1
    {
    }
...
namespace Parser
{
    ...
    public class IISFTPV_1_0_0Recorder : Parser//recorderName***
    {
        ...
        public IISFTPV_1_0_0Recorder()//recorderName
            : base()
        {
            LogName = "IISFTPV_1_0_0Recorder";//recorderName***
        ...
        public IISFTPV_1_0_0Recorder(String fileName)//recorderName***
            : base(fileName)
        {
                        ...
                        if (!line.StartsWith("#"))
                        {
                            ...
                            for (int i = 0; i < lineArr.Length; i++)
                            {
                                if(lineArr[i].ToString()=="User")
                                {
                                    ...
                                    rec.EventType = lineArr[lineArr.Length - 2] + " " + lineArr[lineArr.Length - 1];
