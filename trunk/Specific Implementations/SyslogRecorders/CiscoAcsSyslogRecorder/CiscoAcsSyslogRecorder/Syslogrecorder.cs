...
{
    public class CiscoACSRecorder : CustomBase
    {   
        ...
        {   
            try
            {
                ...
                {
                    CiscoACSRecorderProcess acsrecorder = new CiscoACSRecorderProcess();

                    acsrecorder.parsingProcess(args, zone);
                    CustomBase.Rec rec = new CustomBase.Rec();
                    rec = acsrecorder.createRec();
                    ...
                    //if (usingRegistry)
                    //{
                    //    sr.sendDataforAgent(rec);
                    //}
                    //else
                    //{
                    //    InitializeLogger.L.Log(LogType.FILE, LogLevel.DEBUG, "Start sending Data");


                    //    sr.sendDataforRemoteRecorder(Dal, virtualhost,rec);
                    //}
                    if (usingRegistry)
                    {
                    ...
                    {
                        InitializeLogger.L.Log(LogType.FILE, LogLevel.INFORM, "Start Sending Data"); 
