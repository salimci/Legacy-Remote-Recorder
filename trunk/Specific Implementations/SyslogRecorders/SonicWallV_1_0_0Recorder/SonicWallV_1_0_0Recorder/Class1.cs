...
namespace SonicWallV_1_0_0Recorder
{
    public class SonicWallV_1_0_0Recorder : CustomBase
    {
        #region Değişkenler
        ...
        public bool Get_logDir()
        {
            ...
            try
            {
                ...
                err_log = rk.OpenSubKey("Remote Recorder").GetValue("Home Directory").ToString() + @"log\SonicWallV_1_0_0Recorder" + Id + ".log";
                rk.Close();
                return true;
            }
            catch (Exception er)
        ...
        public SonicWallV_1_0_0Recorder()
        {
            id = null;
            sn = null;
            time = null;
        ...
        void slog_SyslogEvent(LogMgrEventArgs args)
        {
            ...
            try
            {
                ...
                L.Log(LogType.FILE, LogLevel.DEBUG, Dal + " Datetime: " + rec.Datetime);
                ...
                else
                {
                    ...
                    s.SetReg(Id, rec.Datetime, "", "", "", DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss"));
                }
