...
namespace ZyxelZywalLUSG_300_V1_1_1_Web_Recorder
{
    public class ZyxelZywalLUSG_300_V1_1_1_Web_Recorder : CustomBase
    {
        ...
        public override void Init()
        {
            try
            {
                if (usingRegistry)
                {
                    if (!reg_flag)
                    {
                        if (!Read_Registry())
                        {
                            ...
                            {
                                L.Log(LogType.FILE, LogLevel.ERROR, "Error on Intialize Logger on ZyxelZywalLUSG_300_V1_1_1_Web_Recorder Recorder functions may not be running");
                                return;
                            }
                        reg_flag = true;
                    }
                ...
                L.Log(LogType.FILE, LogLevel.INFORM, "Finish initializing ZyxelZywalLUSG_300_V1_1_1_Web_Recorder Event");
            }
            catch (Exception er)
            {
                EventLog.WriteEntry("Security Manager ZyxelZywalLUSG_300_V1_1_1_Web_Recorder Recorder Init", er.ToString(), EventLogEntryType.Error);
            }
        } // Init 
        ...
        public bool Get_logDir()
        {
            ...
            try
            {
                ...
                err_log = rk.OpenSubKey("Remote Recorder").GetValue("Home Directory").ToString() + @"log\ZyxelZywalLUSG_300_V1_1_1_Web_Recorder" + Id + ".log";
                rk.Close();
                return true;
            }
            catch (Exception er)
            {
                EventLog.WriteEntry("Security Manager ZyxelZywalLUSG_300_V1_1_1_Web_Recorder Recorder Read Registry", er.ToString(), EventLogEntryType.Error);
                return false;
            }
            finally
            {
        ...
        public ZyxelZywalLUSG_300_V1_1_1_Web_Recorder()
        {
        ...
        void Sgs_SyslogEvent(LogMgrEventArgs args)
        {
            ...
            try
            {
                L.Log(LogType.FILE, LogLevel.DEBUG, "ZyxelZywalLUSG_300_V1_1_1_Web_Recorder() | Start preparing record");
                string sLogLine = args.Message;
                L.Log(LogType.FILE, LogLevel.DEBUG, "ZyxelZywalLUSG_300_V1_1_1_Web_Recorder() | start line=" + sLogLine);
                ...
                rec.LogName = "ZyxelZywalLUSG_300_V1_1_1_Web_Recorder";
                rec = LogFormat_Message(sLogLine, rec);

                
                L.Log(LogType.FILE, LogLevel.DEBUG, "ZyxelZywalLUSG_300_V1_1_1_Web_Recorder()  EventLogEntType: " + args.EventLogEntType.ToString());
                L.Log(LogType.FILE, LogLevel.DEBUG, "ZyxelZywalLUSG_300_V1_1_1_Web_Recorder()  Source: " + args.Source.ToString());
                L.Log(LogType.FILE, LogLevel.DEBUG, "ZyxelZywalLUSG_300_V1_1_1_Web_Recorder()  Message: " + args.Message.ToString());

                rec.SourceName = args.Source;
                
                L.Log(LogType.FILE, LogLevel.DEBUG, "ZyxelZywalLUSG_300_V1_1_1_Web_Recorder() | Start sending Data");

                if (usingRegistry)
                {
                    CustomServiceBase s = base.GetInstanceService("Security Manager Sender");
                    s.SetData(rec);
                    L.Log(LogType.FILE, LogLevel.DEBUG, "ZyxelZywalLUSG_300_V1_1_1_Web_Recorder() usingRegistry |  Finish Sending Data");
                }
                else
                {
                    ...
                    L.Log(LogType.FILE, LogLevel.DEBUG, "ZyxelZywalLUSG_300_V1_1_1_Web_Recorder() |  Finish Sending Data");
                }
            }
            catch (Exception er)
            {
                L.Log(LogType.FILE, LogLevel.ERROR, "ZyxelZywalLUSG_300_V1_1_1_Web_Recorder() | " + er.ToString());
                L.Log(LogType.FILE, LogLevel.ERROR, "ZyxelZywalLUSG_300_V1_1_1_Web_Recorder() | " + args.Message);
            }
        } // Sgs_SyslogEvent
        ...
        private Rec LogFormat_Message(string sLogLine, Rec rec)
        {
            try
            {
                ...
                char c = '"';
                string strPort1 = Between(sLogLine, "src=", "dst=").Replace('"',' ').Trim();
                ...
                try
                {
                    rec.CustomStr1 = Between(sLogLine, "devID=", "cat=").Replace('"',' ').Trim();
                }
                catch (Exception exception)
                {
        ...
        public bool Read_Registry()
        {
            ...
            {
                rk = Registry.LocalMachine.OpenSubKey("SOFTWARE").OpenSubKey("Natek").OpenSubKey("Security Manager");
                err_log = rk.OpenSubKey("Agent").GetValue("Home Directory").ToString() + @"log\ZyxelZywalLUSG_300_V1_1_1_Web_Recorder.log";
                Syslog_Port = Convert.ToInt32(rk.OpenSubKey("Recorder").OpenSubKey("ZyxelZywalLUSG_300_V1_1_1_Web_Recorder").GetValue("Syslog Port"));
                trc_level = Convert.ToInt32(rk.OpenSubKey("Recorder").OpenSubKey("ZyxelZywalLUSG_300_V1_1_1_Web_Recorder").GetValue("Trace Level"));
                return true;
            }
            catch (Exception er)
            {
                EventLog.WriteEntry("Security Manager ZyxelZywalLUSG_300_V1_1_1_Web_Recorder Read Registry", er.ToString(), EventLogEntryType.Error);
                return false;
            }
            finally
            {
        ...
        public bool Initialize_Logger()
        {
            ...
            {
                EventLog.WriteEntry("Security Manager ZyxelZywalLUSG_300_V1_1_1_Web_Recorder Recorder", er.ToString(), EventLogEntryType.Error);
                return false;
            }
        } // Initialize_Logger
