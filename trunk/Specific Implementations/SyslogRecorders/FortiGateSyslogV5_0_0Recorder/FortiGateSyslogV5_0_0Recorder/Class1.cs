...
namespace FortiGateSyslogV5_0_0Recorder
{
    public class FortiGateSyslogV5_0_0Recorder : CustomBase
    {
        ...
        public bool Get_logDir()
        {
            ...
            try
            {
                ...
                err_log = rk.OpenSubKey("Remote Recorder").GetValue("Home Directory").ToString() + @"log\FortiGateSyslogV5_0_0Recorder" + Id + ".log";
                rk.Close();
                return true;
            }
            catch (Exception er)
        ...
        public FortiGateSyslogV5_0_0Recorder()
        {
            /*
            try
            {
        ...
        void slog_SyslogEvent(LogMgrEventArgs args)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    //utmevent = sourcename;
                    //user
                    rec.LogName = "FortiGateSyslogV5_0_0Recorder";
