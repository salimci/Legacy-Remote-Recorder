//WatchGuardWebV_11_7_3_0SyslogRecorder
...
namespace WatchGuardWebV_11_7_3_0SyslogRecorder
{
    public class WatchGuardWebV_11_7_3_0SyslogRecorder : CustomBase
    {
        ...
        public override void Init()
        {
                ...
                if (usingRegistry)
                {
                    if (!reg_flag)
                    {
                        if (!Read_Registry())
                        {
                            ...
                            {
                                L.Log(LogType.FILE, LogLevel.ERROR, "Error on Intialize Logger on WatchGuardWebV_11_7_3_0SyslogRecorder functions may not be running");
                                return;
                            }
                        reg_flag = true;
                    }
            ...
            {
                EventLog.WriteEntry("Security Manager WatchGuardWebV_11_7_3_0SyslogRecorder Init", er.ToString(), EventLogEntryType.Error);
            }
        }
        ...
        public bool Get_logDir()
        {
            ...
            try
            {
                ...
                err_log = rk.OpenSubKey("Remote Recorder").GetValue("Home Directory").ToString() + @"log\WatchGuardWebV_11_7_3_0SyslogRecorder" + Id + ".log";
                rk.Close();
                return true;
            }
            catch (Exception er)
            {
                EventLog.WriteEntry("Security Manager WatchGuardWebV_11_7_3_0SyslogRecorder Read Registry", er.ToString(), EventLogEntryType.Error);
                return false;
            }
            finally
            {
        ...
        public WatchGuardWebV_11_7_3_0SyslogRecorder()
        {
            /*
            try
            {
        ...
        void slog_SyslogEvent(LogMgrEventArgs args)
        {
            ...
            try
            {
                ...
                try
                {
                    rec.LogName = "WatchGuardWebV_11_7_3_0SyslogRecorder";
                    ...
                    if (lineArr.Length > 8)
                    {
                        ...
                        {
                            rec.CustomStr5 = lineArr[8].Split('-')[0];
                    ...
                    try
                    {
                        ...
                        {
                            rec.CustomInt3 = Convert.ToInt32(lineArr[15]);
                    ...
                    try
                    {
                        ...
                        {
                            rec.CustomInt4 = Convert.ToInt32(lineArr[16]);
        ...
        public bool Initialize_Logger()
        {
            ...
            {
                EventLog.WriteEntry("Security Manager WatchGuardWebV_11_7_3_0SyslogRecorder", er.ToString(), EventLogEntryType.Error);
                return false;
            }
        }
    }
