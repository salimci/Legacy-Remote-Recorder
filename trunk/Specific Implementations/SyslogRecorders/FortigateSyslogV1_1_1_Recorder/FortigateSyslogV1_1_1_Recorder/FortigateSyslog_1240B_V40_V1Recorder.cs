...
{
    public class FortigateSyslog_1240B_V40_V1Recorder : CustomBase
    {
        ...
        public void get_logDir()
        {
            ...
            try
            {
                ...
                err_log = rk.OpenSubKey("Remote Recorder").GetValue("Home Directory").ToString() + @"log\FortigateSyslog_1240B_V40_V1Recorder" + identity + ".log";
            }
            catch (Exception ess)
            {
        ...
        public override void Start()
        {
            ...
            {
                EventLog.WriteEntry("Security Manager FortigateSyslogV1_1_1_Recorder Constructor", er.ToString(), EventLogEntryType.Error);
            }

        }

        public FortigateSyslog_1240B_V40_V1Recorder()
        {
        ...
        {
            L.Log(LogType.FILE, LogLevel.INFORM, "parsWEBFILTER");
            L.Log(LogType.FILE, LogLevel.INFORM, "line : " + line);
            L.Log(LogType.FILE, LogLevel.INFORM, "line2 : " + line2);
            #region WebFilter
            string tarih = "";
        ...
        {
            L.Log(LogType.FILE, LogLevel.INFORM, "parsVIRUS");
            L.Log(LogType.FILE, LogLevel.INFORM, "line : " + line);
            L.Log(LogType.FILE, LogLevel.INFORM, "line2 : " + line2);
            #region AttackIPS
            string tarih = "";
        ...
        {
            L.Log(LogType.FILE, LogLevel.INFORM, "parsOTHER");
            L.Log(LogType.FILE, LogLevel.INFORM, "line : " + line);
            L.Log(LogType.FILE, LogLevel.INFORM, "line2 : " + line2);
            #region Traffic
        ...
        {
            L.Log(LogType.FILE, LogLevel.INFORM, "fortigate_Syslog");
            Rec r = new Rec();
            ...
            try
            {
                ...
                L.Log(LogType.FILE, LogLevel.DEBUG, "fortigate_Syslog: arr: " + arr + " , _type: " + _type);
        ...
        {
            L.Log(LogType.FILE, LogLevel.INFORM, "CreateRecord - start");

            for (int i = 0; i < arr.Length; i++)
            {
                L.Log(LogType.FILE, LogLevel.INFORM, "CreateRecord - arr " + "[" + i + "]" + arr[i]);
            }
            L.Log(LogType.FILE, LogLevel.INFORM, "CreateRecord - type" + type);
            ...
            try
            {
                ...
                for (int i = indexofequal; i < arr.Length - 1; i++)
                {
                    ...
                    if (bol.Length > 1)
                    {
                        ...
                        L.Log(LogType.FILE, LogLevel.DEBUG, "CreateRecord: type: " + type);
                        switch (type)
                        {
                            case "traffic":
        ...
        {
            L.Log(LogType.FILE, LogLevel.INFORM, "Read_Registry");
            RegistryKey rk = null;
            try
            {
                rk = Registry.LocalMachine.OpenSubKey("SOFTWARE").OpenSubKey("Natek").OpenSubKey("Security Manager");
            ...
            {
                EventLog.WriteEntry("Security Manager FortigateSyslogV1_1_1_Recorder Read Registry", er.ToString(), EventLogEntryType.Error);
                return false;
            }
            finally
            {
        ...
        public bool Initialize_Logger()
        {
            ...
            {
                EventLog.WriteEntry("Security Manager FortigateSyslog_1240B_V40_V1Recorder Recorder", er.ToString(), EventLogEntryType.Error);
                return false;
            }
        }
    }
